...
-- 시퀀스 (순차적으로 증가하는 값을 만들어주는 주는 객체)

CREATE SEQUENCE dept2_seq
    START WITH 1 -- 시작값 (기본값은 증가할 때 최소값, 감소할 때 최대값)
    INCREMENT BY 1 -- 증가값 (양수면 증가, 음수면, 감소, 기본값 1) 생략 가능 기본값이 있기 때문에
...
ALTER SEQUENCE dept2_seq INCREMENT BY -80;

...
EXEC my_new_job_proc('JOB2', 'test_job3', 2000, 3000);
...
EXEC my_new_job_proc('JOB5', 'test_job5');
...
DECLARE
    msg VARCHAR2(100);
BEGIN
    my_new_job_proc('JOB2', 'test_jpb2', 2000, 8000, msg);
...
END; -- 에러가 뜨면 ORA-01476 또는 ORA-06512 ... 등등 구글에 치면 다 나옴.
